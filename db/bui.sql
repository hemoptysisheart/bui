...
-- Table `op_operator`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `op_operator` (
...
-- -----------------------------------------------------
-- Table `op_operator_credential`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `op_operator_credential` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
